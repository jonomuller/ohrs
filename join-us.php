    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-9 col-xs-12">
          ...
          <p>If you would like to join the society and subscribe to our newsletter, please fill out the form below.</p>
          <form id="subscribe-form">
            ...
            <div id="button-area">
              <button id="submit-button" type="submit" data-hide="alert" class="btn btn-default">Join us</button>
            </div>
          </form>
        </div>
        <div class="col-md-3 col-xs-12">
          <div class="row">
            <div class="col-xs-12 col-md-12">
              <h3>Contact us</h3>
              <p><a href="mailto:info@ohrs.org.uk">info@ohrs.org.uk</a></p>
